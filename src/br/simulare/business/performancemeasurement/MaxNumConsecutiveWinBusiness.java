...
/**
 * Maximum number of consecutive winning business.
 * 
 * @author Alâynne Moreira
 * @since Version 1.0
 */

public class MaxNumConsecutiveWinBusiness implements PerformanceMeasurement {
	...
	public String getName() {
		...
		return "Max. Number of Consecutive Winning Business." +
				".....: ";
